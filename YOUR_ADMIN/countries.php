...
/* bof - 1 of XX - Selectable Countries */
...
/* eof - 1 of XX - Selectable Countries */
      ...
      case 'save':
        ...
        $countries_iso_code_3 = zen_db_prepare_input($_POST['countries_iso_code_3']);
        $address_format_id = zen_db_prepare_input($_POST['address_format_id']);
/* bof - 2 of XX - Selectable Countries */
        $countries_active = zen_db_prepare_input($_POST['countries_active']);
...
/* eof - 2 of XX - Selectable Countries */
      ...
      case 'deleteconfirm':
        ...
        zen_redirect(zen_href_link(FILENAME_COUNTRIES, 'page=' . $_GET['page']));
        break;
/* bof - 3 of XX - Selectable Countries */
      case 'status':
        $countries_id = zen_db_prepare_input($_GET['cID']);
        if (isset($_POST['current_status']) && ($_POST['current_status'] == '0' || $_POST['current_status'] == '1')) {
          $sql = "update " . TABLE_COUNTRIES . " set countries_active='" . ($_POST['current_status'] == '0' ? '1' : '0') . "' where countries_id='" . (int)$countries_id . "'";
          $db->Execute($sql);
          $action = '';
          zen_redirect(zen_href_link(FILENAME_COUNTRIES, 'cID=' . (int)$countries_id . '&page=' . $_GET['page'], 'NONSSL'));
        }
        $action = '';
        break;
/* eof - 3 of XX - Selectable Countries */
    }
  }
?>
...
<?php
/* bof - 4 of XX - Selectable Countries */
?>
                <td class="dataTableHeadingContent" align="center"><?php echo TABLE_HEADING_COUNTRY_ACTIVE; ?></td>
<?php
/* eof - 4 of XX - Selectable Countries */
?>
                <td class="dataTableHeadingContent" align="right"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
              </tr>
<?php
/* bof - 5 of XX - Selectable Countries */
...
/* eof - 5 of XX - Selectable Countries */
...
<?php
/* bof - 6 of XX - Selectable Countries */
?>
                <td class="dataTableContent" align="center" width="40">
<?php
    echo zen_draw_form('setstatus', FILENAME_COUNTRIES, 'action=status&cID=' . $countries->fields['countries_id'] . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '') . (isset($_GET['search']) ? '&search=' . $_GET['search'] : ''));
    if ($countries->fields['countries_active'] == '0') {
...
?>
                    ...
                    <input type="hidden" name="current_status" value="<?php echo $countries->fields['countries_active']; ?>" />
                  </form>
                </td>
<?php
/* eof - 6 of XX - Selectable Countries */
?>
...
/* bof - 7 of XX - Selectable Countries */
        $contents[] = array('text' => '<br>' . TEXT_INFO_COUNTRY_ACTIVE . '  ' . (($cInfo->countries_active == '0') ? TEXT_NO : TEXT_YES));
/* eof - 7 of XX - Selectable Countries */
      }
      break;
  }
