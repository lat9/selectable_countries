...
/* bof - Selectable Countries */
define('TABLE_HEADING_COUNTRY_ACTIVE', 'Active Country');
define('TEXT_INFO_COUNTRY_ACTIVE', 'Ship to This Country?');
/* eof - Selectable Countries */
